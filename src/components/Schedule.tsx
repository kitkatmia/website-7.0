...
const rows = [
  ...
  createData("10:30AM", "Intro to IOS Workshop"),
  createData("11:30AM", "Lunch (provided by MVHacks)"),
  createData("1:00PM", "Resume Building Workshop by Crowdstrike"),
  createData("2:00PM", "Guess the Image Game"),
  createData("3:00PM", "Developing Websites With React Workshop"),
  createData("4:30PM", "Geoguessr Multiplayer Live Game"),
